/**
 * Singleton xterm.js CSS injection.
 *
 * xterm.js CSS is embedded inline because require.resolve is unavailable
 * in Obsidian's bundled context. Injected once into document.head.
 */
let injected = false;
